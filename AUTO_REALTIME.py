                ...
                if df is not None and info:
                    ...
                    <div class="stock-data">
                        ...
                        <div style='display: flex; justify-content: space-between; width: 100%;'>
                            <div><strong>Current Price:</strong> ${info['price']:.2f}</div>
                            <div><strong>Low Price:</strong> ${info['low']:.2f}</div>
                            <div><strong>High Price:</strong> ${info['high']:.2f}</div>
                            <div><strong>Volume:</strong> {info['volume']:,}</div>
                        </div>
                    </div>
                    """
